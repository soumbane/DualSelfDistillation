...
python train_basic.py /home/neil/Lab_work/Medical_Image_Segmentation/Data_MMWHS_All/CT /home/neil/Lab_work/Medical_Image_Segmentation/Dual_SelfDistillation/trained_models/last_CT_MMWHS_Basic.pth --img_size 96 96 96 --batch_size 1 --epochs 600 --experiment CT_MMWHS_UNETR_Basic.exp --training_split 4 --device cuda:0 --show_verbose
